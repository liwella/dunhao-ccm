...
`,[S("scrollbar",`
 ...
 `)]),_("render-label",`
 color: var(--n-text-color);
 `)]),Je("disabled",[Y("&:hover",[_("state-border",`
 ...
 opacity: 0;
 `)]),["warning","error"].map(e=>q(`${e}-status`,[_("state-border",`border: var(--n-border-${e});`),Je("disabled",[Y("&:hover",[_("state-border",`
