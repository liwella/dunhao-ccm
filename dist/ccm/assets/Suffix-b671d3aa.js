...
`,[o(">",[s("clear",`
 ...
 `,[f({originalTransform:"translateX(-50%) translateY(-50%)",left:"50%",top:"50%"})])])]),x=n({name:"BaseClear",props:{clsPrefix:{type:String,required:!0},show:Boolean,onClear:Function},setup(l){return u("-base-clear",v,h(l,"clsPrefix")),{handleMouseDown(a){a.preventDefault()}}},render(){const{clsPrefix:l}=this;return e("div",{class:`${l}-base-clear`},e(C,null,{default:()=>{var a,r;return this.show?e("div",{key:"dismiss",class:`${l}-base-clear__clear`,onClick:this.onClear,onMousedown:this.handleMouseDown,"data-clear":!0},t(this.$slots.icon,()=>[e(i,{clsPrefix:l},{default:()=>e(p,null)})])):e("div",{key:"icon",class:`${l}-base-clear__placeholder`},(r=(a=this.$slots).placeholder)===null||r===void 0?void 0:r.call(a))}}))}}),g=n({name:"InternalSelectionSuffix",props:{clsPrefix:{type:String,required:!0},showArrow:{type:Boolean,default:void 0},showClear:{type:Boolean,default:void 0},loading:{type:Boolean,default:!1},onClear:Function},setup(l,{slots:a}){return()=>{const{clsPrefix:r}=l;return e(w,{clsPrefix:r,class:`${r}-base-suffix`,strokeWidth:24,scale:.85,show:l.loading},{default:()=>l.showArrow?e(x,{clsPrefix:r,show:l.showClear,onClear:l.onClear},{placeholder:()=>e(i,{clsPrefix:r,class:`${r}-base-suffix__arrow`},{default:()=>t(a.default,()=>[e(L,null)])})}):null})}}});export{L as C,x as N,g as a};
